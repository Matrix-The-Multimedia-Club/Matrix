...
const TeamProfile = ({ member }) => {
  ...
  return (
    ...
    >
      ...
      {/* Member Details */}
      <h2 className="text-2xl font-bold tracking-wide">{member.name}</h2>
      <p className="text-sm text-cyan-300 font-semibold mt-1 uppercase tracking-wider">{member.role}</p>
      ...
      <div className="flex justify-center gap-4">
        ...
        {/* GitHub */}
        {member.github && (
          <a href={member.github} target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-white/5 hover:bg-gray-600/20 border border-white/10 transition-colors" aria-label="GitHub" title="GitHub">
        ...
        {/* Instagram */}
        {member.instagram && (
          <a href={member.instagram} target="_blank" rel="noopener noreferrer" className="p-3 rounded-full bg-white/5 hover:bg-pink-500/20 border border-white/10 transition-colors" aria-label="Instagram" title="Instagram">
        ...
        {/* Email */}
        {member.email && (
          <a href={`mailto:${member.email}`} className="p-3 rounded-full bg-white/5 hover:bg-orange-500/20 border border-white/10 transition-colors" aria-label="Email" title="Email">
